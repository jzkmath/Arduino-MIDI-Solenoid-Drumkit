...
LIBS:Pluralsight_Drumkit-cache
EELAYER 29 0
EELAYER END
$Descr A4 11693 8268
encoding utf-8
...
U 1 1 5CBFDB47
P 3025 1600
F 0 "U3" H 2865 1950 50  0000 C CNN
F 1 "6N138" H 3115 1950 50  0000 C CNN
F 2 "Package_DIP:DIP-8_W7.62mm_LongPads" H 3315 1300 50  0001 C CNN
F 3 "http://www.onsemi.com/pub/Collateral/HCPL2731-D.pdf" H 3315 1300 50  0001 C CNN
	1    3025 1600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CBFF05E
P 2325 1600
F 0 "D1" H 2325 1700 50  0000 C CNN
F 1 "1N914" H 2325 1500 50  0000 C CNN
F 2 "Diode_THT:D_DO-15_P15.24mm_Horizontal" H 2325 1600 50  0001 C CNN
...
U 1 1 5CBFF852
P 2025 1425
F 0 "R1" V 2105 1425 50  0000 C CNN
F 1 "220" V 2025 1425 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P15.24mm_Horizontal" V 1955 1425 50  0001 C CNN
...
U 1 1 5CBFFCEC
P 3725 1450
F 0 "R3" V 3805 1450 50  0000 C CNN
F 1 "220" V 3725 1450 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P15.24mm_Horizontal" V 3655 1450 50  0001 C CNN
...
U 1 1 5CC0005A
P 3550 1925
F 0 "R2" V 3630 1925 50  0000 C CNN
F 1 "4.7k" V 3550 1925 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P15.24mm_Horizontal" V 3480 1925 50  0001 C CNN
...
U 1 1 5CC0094B
P 1450 1325
F 0 "J1" H 1575 1550 50  0000 C CNN
F 1 "MIDI DIN" H 1450 1075 50  0000 C CNN
F 2 "Connectors:SDS-50J" H 1450 1325 50  0001 C CNN
F 3 "http://www.mouser.com/ds/2/18/40_c091_abd_e-75918.pdf" H 1450 1325 50  0001 C CNN
	1    1450 1325
	-1   0    0    1   
$EndComp
Wire Wire Line
...
MIDI_Rx
Text Notes 1775 975  0    118  ~ 24
MIDI Interface
$Comp
L Transistor_Array:ULN2003A U1
U 1 1 5CC3B012
P 2350 4100
F 0 "U1" H 2350 4725 50  0000 C CNN
F 1 "ULN2003A" H 2350 4650 50  0000 C CNN
F 2 "Package_DIP:DIP-16_W7.62mm_LongPads" H 2400 3550 50  0001 L CNN
F 3 "http://www.ti.com/lit/ds/symlink/uln2003a.pdf" H 2450 3900 50  0001 C CNN
	1    2350 4100
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CC3DFCE
P 3375 2175
F 0 "#PWR011" H 3375 1925 50  0001 C CNN
F 1 "GND" H 3375 2025 50  0000 C CNN
...
U 1 1 5CC3E99B
P 3725 1175
F 0 "#PWR012" H 3725 1025 50  0001 C CNN
F 1 "+5V" H 3725 1315 50  0000 C CNN
...
U 1 1 5CC4D62C
P 2800 3600
F 0 "#PWR09" H 2800 3450 50  0001 C CNN
...
U 1 1 5CCB632C
P 2375 5650
F 0 "U2" H 2375 6275 50  0000 C CNN
F 1 "ULN2003A" H 2375 6200 50  0000 C CNN
F 2 "Package_DIP:DIP-16_W7.62mm_LongPads" H 2425 5100 50  0001 L CNN
F 3 "http://www.ti.com/lit/ds/symlink/uln2003a.pdf" H 2475 5450 50  0001 C CNN
	1    2375 5650
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CCB6341
P 2825 5150
F 0 "#PWR010" H 2825 5000 50  0001 C CNN
F 1 "+5V" H 2825 5290 50  0000 C CNN
...
Wire Wire Line
	2825 5250 2775 5250
Text GLabel 2925 5450 2    50   Output ~ 0
S8
Text GLabel 2925 5550 2    50   Output ~ 0
S9
Text GLabel 2925 5650 2    50   Output ~ 0
S10
Text GLabel 2925 5750 2    50   Output ~ 0
S11
Text GLabel 2925 5850 2    50   Output ~ 0
S12
Text GLabel 2925 5950 2    50   Output ~ 0
S13
Text GLabel 2925 6050 2    50   Output ~ 0
S14
Wire Wire Line
	2775 5450 2925 5450
Wire Wire Line
...
Wire Wire Line
	1825 4500 1950 4500
Text Label 1825 4000 2    50   ~ 0
3(**)
Text Label 1825 4100 2    50   ~ 0
4(**)
Text Label 1825 4200 2    50   ~ 0
5(**)
Text Label 1825 4300 2    50   ~ 0
6(**)
Text Label 1825 4400 2    50   ~ 0
7(**)
Text Label 1825 4500 2    50   ~ 0
8(**)
Wire Wire Line
	1825 5450 1975 5450
Wire Wire Line
...
Wire Wire Line
	1825 6050 1975 6050
Text Label 1825 5450 2    50   ~ 0
9(**)
Text Label 1825 5550 2    50   ~ 0
10(**)
Text Label 1825 5650 2    50   ~ 0
11(**)
Text Label 1825 5750 2    50   ~ 0
12(**)
Text Label 1825 5850 2    50   ~ 0
13(**)
Text Label 1825 5950 2    50   ~ 0
14(Tx3)
Text Label 1825 6050 2    50   ~ 0
15(Rx3)
Text Notes 2950 3300 2    118  ~ 24
Solenoid Drivers
$Comp
...
F 1 "Solenoid Connector" H 4650 4050 50  0000 C CNN
F 2 "Pluralsight:PinHeader_2x14_P2.54mm_Vertical_zigzag" H 4600 4850 50  0001 C CNN
...
U 1 1 5CDF9721
P 4950 4175
F 0 "#PWR0101" H 4950 4025 50  0001 C CNN
F 1 "+5V" H 4950 4315 50  0000 C CNN
...
U 1 1 5CC23E58
P 5325 1350
F 0 "J3" H 5325 1450 50  0000 C CNN
F 1 "Prog Jumper" H 5325 1150 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 5325 1350 50  0001 C CNN
...
U 1 1 5CC42C72
P 5325 2125
F 0 "J4" H 5325 2225 50  0000 C CNN
F 1 "Power" H 5325 1925 50  0000 C CNN
F 2 "Pluralsight:2_Pos_Screw_Term" H 5325 2125 50  0001 C CNN
...
U 1 1 5CC43523
P 5075 2300
F 0 "#PWR014" H 5075 2050 50  0001 C CNN
F 1 "GND" H 5075 2150 50  0000 C CNN
F 2 "" H 5075 2300 50  0001 C CNN
F 3 "" H 5075 2300 50  0001 C CNN
	1    5075 2300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CC43D50
P 5075 2050
F 0 "#PWR013" H 5075 1900 50  0001 C CNN
F 1 "+5V" H 5075 2190 50  0000 C CNN
